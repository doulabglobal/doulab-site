    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text:
            'A modular set of canvases that makes innovation repeatable—from discovery to delivery.',
        },
      },
      {
        '@type': 'Question',
  ...
  return (
    ...
    >
      <Head>
        ...
        {/* LCP preload for hero image; AVIF/WebP sources will still be selected by the browser */}
        <link
          rel="preload"
          as="image"
          href="/img/about.png"
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'center' }}>
            <div style={{ flex: '1 1 460px', paddingRight: '2rem' }}>
              ...
              <div className="heroCtas">
                <Link to="/contact" className="buttonPrimary" data-cta="cta.about.hero.contact" aria-label="Book a discovery call">
                  Book a discovery call
                </Link>
                <Link to="/case-studies" className="buttonSecondary" data-cta="cta.about.hero.case_studies" aria-label="See case studies">
                  See case studies
                </Link>
              </div>

              {/* In-page nav */}
              <nav className="heroCtas" aria-label="About page sections" style={{ marginTop: '.75rem' }}>
                <a className="buttonSecondary" href="#our-story">Our Story</a>
                <a className="buttonSecondary" href="#service-pillars">Our service pillars</a>
                <a className="buttonSecondary" href="#ecosystem-building">Ecosystem Building</a>
                <a className="buttonSecondary" href="#faq">FAQ</a>
              </nav>
            </div>
        ...
        <section className="section" aria-labelledby="cta-title">
          <div className="finalCta">
            ...
            <div className="heroCtas" style={{ justifyContent: 'center' }}>
              <Link to="/what-we-do#diagnostics" className="buttonPrimary" data-cta="cta.about.final.start_diagnostic">
