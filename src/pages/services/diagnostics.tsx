            ...
            <main>
                ...
                <section className="heroBanner" aria-labelledby="diagnostics-hero-title">
                    <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'center' }}>
                        <div style={{ flex: '1 1 520px', paddingRight: '2rem' }}>
                            ...
                            <div className="heroCtas">
                                <Link className="buttonPrimary" to="/services/clarityscan" data-cta="cta.diagnostics.hero.clarityscan">
                ...
                <section className="section" aria-labelledby="diagnostics-offer-title">
                    ...
                    <div className="cardGrid">
                        ...
                        <article className="card" aria-labelledby="scan-foresight-title">
                            ...
                            <div className="cardFooter">
                                <Link className="cardCta" to="/contact" data-cta="cta.diagnostics.offer.foresight">
                                    Enquire →
                                </Link>
                            </div>
                        </article>
                        ...
                        <article className="card" aria-labelledby="scan-operating-title">
                            ...
                            <div className="cardFooter">
                                <Link className="cardCta" to="/contact" data-cta="cta.diagnostics.offer.operating_model">
                                    Enquire →
                                </Link>
                            </div>
                        </article>
                    ...
                    {/* Selection helper */}
                    <div className="lead" style={{ marginTop: '0.75rem' }}>
                ...
                <section className="section" aria-hidden="true">
                    <p style={{ textAlign: 'center', opacity: 0.75, fontSize: '0.85rem', marginTop: '-1rem' }}>
