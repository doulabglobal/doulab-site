...
<CaseVignetteCard
  title="Diseño de punto de control Heilmeier"
  ...
  intervention="Se usaron preguntas estructuradas del Catecismo de Heilmeier para enmarcar las puntos de control."
  outcome="Los puntos de control de decisión y las necesidades de evidencia se clarificaron antes de escalar."
  lesson="Las preguntas estructuradas pueden apoyar el diseño de puntos de control basado en evidencia."
  source={<>
    DARPA (n.d.).{" "}
    <a
