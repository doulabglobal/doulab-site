...
export default function Contact(): ReactNode {
  const contactSchema = {
    ...
    contactPoint: [{ '@type': 'ContactPoint', contactType: 'Business', email: EMAIL, availableLanguage: ['en', 'es'] }],
  };

  return (
    <Layout title="Contact - Doulab" description="Start a discovery call or send us a brief. Privacy-first, no third-party forms.">
      <Head>
      ...
      <main>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'center' }}>
            <div style={{ flex: '1 1 820px' }}>
              ...
              <div className="heroCtas">
                <a className="buttonPrimary" href={`mailto:${EMAIL}?subject=Discovery%20call%20request&body=Hi%20Doulab%2C%20I%27d%20like%20to%20book%20a%2020-min%20discovery%20call.%20My%20goal%20is%20...`} data-cta="cta.contact.hero.email" aria-label="Email Doulab to request a discovery call">
        ...
        <section className="section" id="options" aria-labelledby="options-title">
          ...
          <p className="sectionLead">Choose what works best for you — each option keeps your data private and gets you to a clear next step.</p>
          <div className="cardGrid">
            <article className="card" aria-labelledby="opt-discovery">
              ...
              <div className="cardFooter">
                <a className="cardCta" href={`mailto:${EMAIL}?subject=Discovery%20call%20request&body=Hi%20Doulab%2C%20Context%3A%20...`} data-cta="cta.contact.card.discovery_email" aria-label="Email to request a discovery call time">Email for a time &rarr;</a>
              </div>
            </article>
            ...
            <article className="card" aria-labelledby="opt-brief">
              ...
              <div className="cardFooter">
                <a className="cardCta" href={`mailto:${EMAIL}?subject=Project%20brief&body=Goal%3A%0ATimeline%3A%0AStakeholders%3A%0AConstraints%3A%0ASuccess%20metrics%3A%0A`} data-cta="cta.contact.card.brief_email" aria-label="Email your project brief">Email your brief &rarr;</a>
              </div>
            </article>
            ...
            <article className="card" aria-labelledby="opt-privacy">
              ...
              <div className="cardFooter">
                <Link className="cardCta" to="/docs/releases" data-cta="cta.contact.card.privacy_more">See what changed &rarr;</Link>
              </div>
            </article>
          </div>
        </section>
        ...
        <section className="section" aria-labelledby="cta-title">
          <div className="finalCta">
            ...
            <div className="heroCtas" style={{ justifyContent: 'center' }}>
              <a className="buttonPrimary" href={`mailto:${EMAIL}?subject=Discovery%20call%20request`} data-cta="cta.contact.final.email" aria-label="Email Doulab to request a discovery call">Email us</a>
              <Link className="buttonSecondary" to="/what-we-do" data-cta="cta.contact.final.whatwedo">See what we do</Link>
            </div>
          </div>
        </section>
      </main>
