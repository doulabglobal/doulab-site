...
export default function CaseAlphaInversiones(): ReactNode {
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Alpha Inversiones: Alpha Escalable y Alpha en Línea', item: 'https://doulab.net/case-studies/alpha-inversiones' },
    ],
  };
  ...
  return (
    ...
    >
      <Head>
        ...
        <meta
          property="og:title"
          content="Alpha Inversiones: Alpha Escalable y Alpha en Línea | Caso de éxito | Doulab"
        />
        <meta
