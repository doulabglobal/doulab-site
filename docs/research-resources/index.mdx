...
<ul className="dl-cards" role="list">
  ...
  <li>
    ...
    <p>A practical incubation model for building startup-ready pipelines and ecosystem-ready ventures.</p>
    <ul>
      <li>Venture progression and readiness signals</li>
      <li>Mentorship, governance, and cadence design</li>
    </ul>
    <a
      className="dl-cardCta"
  ...
  <li>
    ...
    <p>A structural framework for designing and governing innovation labs as long-lived institutional systems.</p>
    <ul>
      <li>Lab governance and portfolio logic</li>
      <li>Networked lab coordination</li>
    </ul>
    <a
      className="dl-cardCta"
