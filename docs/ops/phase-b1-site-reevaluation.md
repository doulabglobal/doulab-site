...
- Booking findings: Mixed providers (Outlook Bookings and Calendly). Placeholder booking link exists. Booking entrypoints currently scattered across pages/components.
